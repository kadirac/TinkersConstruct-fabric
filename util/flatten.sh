#!/bin/bash
# Copyright (c) 2014 Nikolay S - MIT
# https://github.com/nick7ikin/bash_flatten_folder/blob/master/flatten_folder.sh
...
OPTIONS:
  ...
  -D DELIMITER               delimiter between path parts instead of '/'. By default it is '_'
